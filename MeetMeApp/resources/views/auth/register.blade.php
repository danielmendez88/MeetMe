    ...
    <div class="register-box">
        ...
        <div class="register-box-body">
            ...
            <form action="{{ url('/register') }}" method="post">
                ...
                <div class="form-group has-feedback">
                    <input type="password" class="form-control" placeholder="Rescribir Contraseña" name="password_confirmation"/>
                ...
                <div class="row">
                    <div class="col-xs-8">
                        <div class="checkbox icheck">
                            <label>
                                <input type="checkbox"> De acuerdo con los <a href="#">terminos</a>
                            </label>
                        </div>
                    </div><!-- /.col -->
                    <div class="col-xs-4">
