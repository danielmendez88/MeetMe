...
<html>
<!--cabecera-->
@section('header_calendar')
    @include('layouts.partials.header_calendar')
@show
              ...
              <div class="box box-solid">
                ...
                <div class="box-body">
                  ...
                  <div id="external-events">
                    <div class="external-event bg-green">Lanzar</div>
                    <div class="external-event bg-yellow">Ir a casa</div>
                    <div class="external-event bg-aqua">Hacer tarea</div>
